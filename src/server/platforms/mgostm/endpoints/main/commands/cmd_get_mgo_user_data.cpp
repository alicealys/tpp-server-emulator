...
namespace emulator::mgo
{
	nlohmann::json cmd_get_mgo_user_data::execute(nlohmann::json& data, const std::optional<database::players::player>& player)
	{
		...
		result["gp_expire"] = mgo_data->get_gp_boost_expire_date();
		...
		result["survival_ticket_remain"] = mgo_data->get_survival_tickets();
		result["xp_boost_mag"] = mgo_data->get_xp_boost_mag();
		result["xp_expire"] = mgo_data->get_xp_boost_expire_date();
