...
namespace database::players
{
	...
	DEFINE_TABLE(players, id_field_t, account_id_field_t, session_id_field_t, 
		login_password_field_t, crypto_key_field_t, last_update_field_t, 
		ex_ip_field_t, ex_port_field_t, in_ip_field_t, in_port_field_t, 
		nat_field_t, creation_time_field_t);
