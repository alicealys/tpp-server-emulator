...
namespace database::event_rankings
{
	...
	enum event_type
	{
		...
		league_point_total = 15,
		league_offsensive_boost = 16,
		league_defensive_boost = 17,
		league_grade_boost = 18,
		league_security_boost = 19,
		league_vehicles = 20,
		league_fight_vehicles = 21,
		league_walker_gears = 22,
		league_emplacements = 23,
		league_wins = 24,
		league_pf_points_exchange = 25,
		league_event_end = 25,
