...
#include "commands/get_svrlist.hpp"
#include "commands/get_svrtime.hpp"
...
namespace tpp
{
	...
	gate_handler::gate_handler()
	{
		...
		this->register_command<get_svrlist_handler>("CMD_GET_SVRLIST");
		this->register_command<get_svrtime_handler>("CMD_GET_SVRTIME");
		//this->register_command<get_informationlist_handler>("CMD_GET_INFORMATIONLIST");
	}
	...
	std::string gate_handler::encrypt_response(const std::uint32_t rq_id, const std::string& msgid, nlohmann::json data)
	{
